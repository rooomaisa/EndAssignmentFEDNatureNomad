...
Start the development server:
npm run dev
The app will run at http://localhost:5173 by default. Open this URL in your browse
...
Create a .env file in the root of the project.
Copy the contents of .env.dist into .env.
Replace the placeholder API keys with the provided key(s).
Run the application:
...
Available npm Commands
Here are the npm commands you can use:
